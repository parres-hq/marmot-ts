...
- [x] 04-07-PLAN.md — portable smoke, offline pressure, and proof-v2 corpus
...
- [x] 04.1-01-PLAN.md — Exact lifecycle-v1 component bytes, defaults, compatibility, and public projection

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 04.1-02-PLAN.md — Parent-relative disband legality plus low-level durable local request and regeneration

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 04.1-03-PLAN.md — Durable request-store construction wiring and public enable/disband publication

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 04.1-04-PLAN.md — Forced linear convergence admission and canonical-only terminal selection

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 04.1-05-PLAN.md — Shared lifecycle-store tombstone persistence, cleanup, and pre-activation hydration
...
- [x] 05-03-PLAN.md — KeyPackage lifetime and capability-delta dossier
- [x] 05-04-PLAN.md — Canonical tag and cardinality dossier
- [x] 05-05-PLAN.md — SafeAAD/Leaf dictionary and capability-delta dossier
- [x] 05-06-PLAN.md — Final-candidate dossier convergence and machine validation
- [x] 05-07-PLAN.md — Blocking candidate push and GitHub authentication checkpoint
- [ ] 05-08-PLAN.md — Authenticated CI retrieval and consolidated immutable quality gate
...
| 5. Quality Gate                          | 7/8 | In Progress|  |
